...
This week I will cover the basic GitHub features and a few more Git skills.
...
[Show me](https://youtu.be/Nfj-PpsvsuM)

* Skill 3. Update a branch from main*
* Skill 4. Delete a branch

[Show me](https://youtu.be/cbXO63jz3S0)

* making changes on main while working on a branch is a recipe for merge conflicts by the way.
...
```
would replace the file `hello.R` on the main branch with the current version of `hello.R` on the development branch. Note the `./` in the path. 
