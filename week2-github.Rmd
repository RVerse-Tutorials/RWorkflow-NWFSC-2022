...
[Show me w GitHub Desktop](https://youtu.be/Nfj-PpsvsuM)

* Skill 3. Update a branch from main*
* Skill 4. Delete a branch

[Show me w GitHub Desktop](https://youtu.be/cbXO63jz3S0)

* making changes on main while working on a branch is a common way to run into merge conflicts by the way.
