...
* [Week 1](rstudio.html). Introduction to workflow using RStudio and Git/GitHub/GitLab [Video](https://www.youtube.com/watch?v=HxIpxVdQsDs)

* [Week 2](coding.html). More Git/GitHub/GitLab + Basic coding practices for reproducible and extendible code [Video](https://noaanmfs-meets.webex.com/recordingservice/sites/noaanmfs-meets/recording/playback/cfdafd50f1444e06a6e451c543ef9f18) Access code mGFWHBD9

* [Week 3](RMarkdown.html). Rmarkdown for reports: how to do big tables and export formats for Word docs [Video](https://noaanmfs-meets.webex.com/recordingservice/sites/noaanmfs-meets/recording/playback/93f61a4954dc4b2dbebb1a78618d6e66) Access code PnVJj7Ve

* [Week 4](packages.html). Part 1. Organizing your R code into a package [Video](https://noaanmfs-meets.webex.com/recordingservice/sites/noaanmfs-meets/recording/playback/805b85c62dc24d4d9ea82e3c3845b395) Access code hMWpH9rC

* [Week 5](roxygen.html). Part 2. Documenting your code and data with Roxygen
