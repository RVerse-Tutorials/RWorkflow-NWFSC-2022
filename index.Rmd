...
* [May 27](week2-github.html) **More GitHub skills: issues, project boards, and releases** This week, I'll cover the basics of reverting changes and using Git branches. Then we'll learn all about GitHub issues, project boards and releases. These features are key to helping you organize your work and keep track of what needs to be done. These features also allow a team to collaborate effectively together on a repository.  
