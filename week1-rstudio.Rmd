...
1. Click here for assignment #1 (don't click if you have already done this): https://classroom.github.com/a/dBZRHuJY
2. Click here to see your repo: https://github.com/RWorkflow-Workshop-2021
3. Copy the url of YOUR new repo url
-->
...
3. Open GitHub Desktop: File > Add Local Repository.
4. Done!
...
3. In your project, click the Terminal tab. Type
    ```
...
Now add a note about those changes to your history and push to GitHub.

**On the RStudio desktop**

3. Switch to GitHub Desktop.
4. Click the changes that you want to commit. And click `Commit`. Add a comment: first line is subject, newline, description (options).
5. Click the Green up arrow to Push to GitHub.

**On the RStudio Cloud**

0. Tell RStudio Cloud you want use Git. Open your project then Click Tools > Global Options > Git/SVN (left nav) and check 'Enable version control for RStudio projects'
![Tools tab is on your project page](images/RStudio-Cloud-Tools.png){25%}
1. Click the Terminal tab in the lower left panel or click the blue cog below the Git tab in the upper right panel.
...
3. Click the Git tab.
4. Click Commit.
5. Click Push, It will ask for your your GitHub user name and password. Hopefully you only have to do this once. *Note: you may get an email from GitHub complaining about accessing GitHub via password. Ignore but accessing GitHub from RStudio may stop working in the future.*

### Make some changes and look at the history

1. Repeat 1-4 a few times.
2. Now look at the history. History in GitHub Desktop. The little clock-like icon in the RStudio Git tab.
...
1. Avoid making changes on GitHub  directly.
  ...
  * Waa, I did and then I forget to pull and now I have merge conflicts. What do I do?? Go to the advanced Git material in the Archive tab above to learn how to deal with merge conflicts.
...
5. The Git info is in the hidden folder `.git`. If you need to get rid of the repository data (like history), delete that. Don't copy that folder into another repo. The remote url is in `.git/config`.
