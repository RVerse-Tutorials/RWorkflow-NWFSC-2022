...
`inst` folder for misc stuff, license, citation
...
I am actually switching to [pkgdown](https://pkgdown.r-lib.org/articles/pkgdown.html) for my landing pages for more developed products. Here is an example of pkgdown being used in the Fisheries Intergrated Toolbox [r4MAS](https://nmfs-fish-tools.github.io/r4MAS/index.html).
