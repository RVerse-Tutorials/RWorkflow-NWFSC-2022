...
For the class, I am going to focus on using Git from GitHub Desktop as it tends not to have the authentication headaches that Git in RStudio has. 

1. Get a [GitHub](https://github.com/) account
2. Install [GitHub Desktop](https://desktop.github.com/)
3. Open GitHub Desktop, go to Preferences, and login to your GitHub account.

## Git from RStudio

If you want to use Git within RStudio, here are the instructions. It can be a real headache to get working for beginners. The following set-up is most likely to work. 
...
If you install GitHub Desktop, you shouldn't need this...
