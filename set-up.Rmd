...
## Using Git from within RStudio

In the class, I am going to use GitHub Desktop, but if you want to use Git from within RStudio or RStudio Cloud then read this section.
