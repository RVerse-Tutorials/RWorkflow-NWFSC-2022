...
If you want to follow along with the presentations, you will need R, RStudio, a GitHub or GitLab account, Git, and GitHub Desktop. Note GitHub Desktop works with both GitHub and GitLab and I will illustrate both.

Summary of the set-up steps. Do them in this order.
...
6. Tell RStudio where git.exe is located
7. Tell Git how to store and get your GitHub/GitLab username and password
8. (optional) Login to GitHub/GitLab from GitHub Desktop

The first time you do these steps, it can take some time and be confusing, but you only do this once.
...
### Install Git
  ...
  * Mac It should be installed. Open a terminal window and type, `git --version`. If it asked to install XCode, say Yes. [Read notes here](https://happygitwithr.com/install-git.html#macos)

### Install GitHub Desktop (Windows and Mac users)

You can use Git through RStudio, but I am also going to show you how to use GitHub Desktop, which is a nice Git interface for basic work. Despite the name, GitHub Desktop works just as well with GitLab.
