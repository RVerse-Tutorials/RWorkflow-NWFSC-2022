...
* **data-raw** A directory for raw data files that produced the data files in **data** folder. Nothing else.
...
Here is an example of pkgdown being used in the Fisheries Integrated Toolbox [r4MAS](https://nmfs-fish-tools.github.io/r4MAS/index.html).
...
This shows an example of code using [piping](https://www.datacamp.com/community/tutorials/pipe-r-tutorial) (`%>%`) versus without. This is why I do not use piping. It is slow and I do simulations and I want fast code.
