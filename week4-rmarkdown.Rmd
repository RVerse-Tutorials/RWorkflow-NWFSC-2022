...
If you are using RStudio on your own computer, there are some packages that you'll need: kritr, kableExtra.
...
I have made a repository [Rmarkdown-Tutorial](https://github.com/RVerse-Tutorials/Rmarkdown-Tutorial) [](https://github.com/RWorkflow-Workshop-2021/Week4-rmarkdown) with some template Rmd files for you to look at.  For this week, you just need the material; you don't to make a repository yourself (linked to GitLab or GitHub).
